...
I/O:
  python -m scripts.intent --mode map     --input '{...}'   --out queries.json
  python -m scripts.intent --mode collision --input '{...}' --out signature.json
"""
...
MAP_SYSTEM = """You read a user's research question and extract 3-5 search queries to send to academic search APIs.
...
- Query 4 (optional): APPLICATION-ANGLE (3-5 words).
- Query 5 (optional): VENUE-INSIDER (5-8 words).
